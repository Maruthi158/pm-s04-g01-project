...
a)_Requirement Analysis_: In this Phase we would collect and finalize requirements from the Client to complete the online website with discussed functionalities.This phase consists of three subtasks:
     1)Gathering Requirements:This phase would deal with collection of requirements from the client
     2)Finalize Requiremnents : This phase would deal with Finalize of requriements
     3)Initial Review:This would deal with review of requirements
